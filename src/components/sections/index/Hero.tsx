      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl">
            Hey, I&apos;m Dots <span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm a 15 year old designer, developer, and media marketer"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://github.com/aiiiddddaaannn"
            ...
            />
            <SocialIcon
              url="https://www.youtube.com/@dotscant"
            ...
            />
            <SocialIcon
              url="https://www.last.fm/user/xokruin"
            ...
            />
            <SocialIcon
              url="https://discord.com/users/1101719929327194113"
